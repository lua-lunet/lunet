...
3b. **NO ISSUE NUMBERS IN CODE OR DOCS:** Do not leave issue numbers, PR numbers, or session-local item numbers in code comments, docs, tests, or workflow comments.
