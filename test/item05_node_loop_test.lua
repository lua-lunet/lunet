-- Test for Item 05: Node Main Loop (Lua; replaces the .sh version).
-- Usage: lunet-run test/item05_node_loop_test.lua
...
local hi_log = root .. "/.tmp/test_item05_hi.log"
local lo_log = root .. "/.tmp/test_item05_lo.log"
local client_log = root .. "/.tmp/test_item05_client.log"
...
lunet.spawn(function()
    ...
    t.check(client_ok, "item05 test client exited 0")
